...
export const AboutConfig = {
  title: "About Me",
  introduction: `Hi, I'm ${PersonalConfig.name}, a ${PersonalConfig.role} with a passion for building web applications. Currently based in ${PersonalConfig.contact.location}, I'm working on creating intuitive and performant web solutions for a variety of clients and personal projects.`,
  profile: {
